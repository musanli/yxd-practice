...
public class MisfireExample {
  ...
  public void run() throws Exception {
    ...
    new LoggingJobHistoryPlugin().initialize("LoggingJobHistoryPlugin",sched,null);
    new LoggingTriggerHistoryPlugin().initialize("LoggingTriggerHistoryPlugin",sched,null);
